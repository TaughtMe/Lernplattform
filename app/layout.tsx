...
import { THEME_INIT_SCRIPT } from "../src/ui/theme.ts";
import "./globals.css";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: "Lernraum verbindet Unterricht und selbstständiges Wiederholen in einer datensparsamen, local-first Lernplattform.",
    openGraph: {
